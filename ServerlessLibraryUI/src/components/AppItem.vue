  ...
  <transition-group name="sample" tag="ul" class="contentlist">
    <li class="sample" v-for="item in samples" :key="item.title">
      <div class="sample__info">
        ...
        <div class="c-header">
          <app-item-type :type="item.type" :language="item.language" class="c-metadata-badge c-item-type itemtype" />          
          <div v-if="item.language !== '' && item.language !== 'na'" class="c-metadata-badge">
<svg  fill="#595959" width="14px" height="14px" viewBox="0 0 2048 2048" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path transform="translate(0,2048) scale(1,-1)" d= "M128 1024L128 1152Q180 1152 227 1172.5Q274 1193 308.5 1227.5Q343 1262 363.5 1308.5Q384 1355 384 1408Q384 1479 381 1550Q378 1621 385.5 1688.5Q393 1756 417.5 1819Q442 1882 496 1936Q550 1990 621 2019Q692 2048 768 2048L768 1920Q715 1920 668.5 1899.5Q622 1879 587.5 1844.5Q553 1810 532.5 1763Q512 1716 512 1664Q512 1608 514 1553.5Q516 1499 514.5 1446.5Q513 1394 505 1344.5Q497 1295 478 1250Q459 1205 426 1164Q393 1123 341 1088Q393 1053 426 1012Q459 971 478 926Q497 881 505 831.5Q513 782 514.5 729.5Q516 677 514 622.5Q512 568 512 512Q512 459 532.5 412.5Q553 366 587.5 331.5Q622 297 668.5 276.5Q715 256 768 256L768 128Q692 128 621 157Q550 186 496 240Q442 294 417.5 357Q393 420 385.5 487.5Q378 555 381 626Q384 697 384 768Q384 820 363.5 867Q343 914 308.5 948.5Q274 983 227 1003.5Q180 1024 128 1024ZM1280 1920L1280 2048Q1356 2048 1427 2019Q1498 1990 1552 1936Q1606 1882 1630.5 1819Q1655 1756 1662.5 1688.5Q1670 1621 1667 1550Q1664 1479 1664 1408Q1664 1355 1684.5 1308.5Q1705 1262 1739.5 1227.5Q1774 1193 1820.5 1172.5Q1867 1152 1920 1152L1920 1024Q1867 1024 1820.5 1003.5Q1774 983 1739.5 948.5Q1705 914 1684.5 867Q1664 820 1664 768Q1664 697 1667 626Q1670 555 1662.5 487.5Q1655 420 1630.5 357Q1606 294 1552 240Q1498 186 1427 157Q1356 128 1280 128L1280 256Q1332 256 1379 276.5Q1426 297 1460.5 331.5Q1495 366 1515.5 412.5Q1536 459 1536 512Q1536 568 1534 622.5Q1532 677 1533.5 729.5Q1535 782 1543 831.5Q1551 881 1570 926Q1589 971 1622 1012Q1655 1053 1707 1088Q1655 1123 1622 1164Q1589 1205 1570 1250Q1551 1295 1543 1344.5Q1535 1394 1533.5 1446.5Q1532 1499 1534 1553.5Q1536 1608 1536 1664Q1536 1716 1515.5 1763Q1495 1810 1460.5 1844.5Q1426 1879 1379 1899.5Q1332 1920 1280 1920Z"></path></svg>
          {{ item.language | ToDisplayLanguage }}</div>
          <span class="c-downloads" v-bind:title="'Downloads\nTotal             : '+item.totaldownloads  +'\nThis month : '+item.downloadsthismonth+'\nThis week    : '+item.downloadsthisweek+'\nToday           : '+item.downloadstoday" >
            <svg viewBox="0 0 12 10" style=" margin-top: 2px;" fill="none" xmlns="http://www.w3.org/2000/svg" class="c-downloads-icon">
      ...
      <ul class="sample__details sampledetails">
        ...
        <li class="sample__data sample__label">
          ...
          <button class="sample__deploybtn fontweight" @click="showConsentModal(item)">Deploy</button>
        </li>
      </ul>
